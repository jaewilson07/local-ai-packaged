...
class GoogleDrive:
    ...
    def execute_query(
        ...
        try:
            ...
            raise ValueError(f"Failed to execute Drive API query: {e}") from e
    ...
    def get_file_metadata(self, file_id: str, fields: str = "*") -> dict[str, Any]:
        ...
        try:
            ...
            raise ValueError(f"Failed to get file metadata for {file_id}: {e}") from e
    ...
    def export_as_media(self, file_id: str, mime_type: str):
        ...
        try:
            ...
            raise ValueError(f"Failed to prepare export for {file_id}: {e}") from e
    ...
    def download_file(self, file_id: str) -> bytes:
        ...
        try:
            ...
            raise ValueError(f"Failed to download file {file_id}: {e}") from e
    ...
    def export_as_markdown(
        ...
        try:
            ...
            raise ValueError(f"Failed to export document {document_id}: {e}") from e
    ...
    def _download_content(self, document_id: str, mime_type: str) -> str:
        ...
        try:
            ...
            raise ValueError(f"Failed to download content for {document_id}: {e}") from e
    ...
    def resolve_folder(
        ...
        try:
            ...
            raise ValueError(f"Failed to resolve folder name: {e}") from e
    ...
    def search(
        ...
        try:
            ...
            raise ValueError(f"Failed to search Google Drive: {e}") from e
