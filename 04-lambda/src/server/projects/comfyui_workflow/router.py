...
from services.external.immich.client import ImmichService
from services.storage.minio.client import MinIOClient
from services.storage.minio.config import MinIOConfig
...
async def generate_from_reference(
    ...
    try:
        # Import dependencies
        from server.projects.controlnet_skeleton.dependencies import get_skeleton_service
        ...
        if use_controlnet and auto_select_skeleton:
            from server.projects.controlnet_skeleton.models import SkeletonSearchRequest
