...
@pytest.mark.asyncio
async def test_query_knowledge_graphiti_enabled(
    mock_deep_research_deps, sample_graphiti_result, sample_mongo_chunk
):
...
@pytest.mark.asyncio
async def test_query_knowledge_graph_hybrid_merge(
    mock_deep_research_deps, sample_graphiti_result, sample_mongo_chunk
):
...
@pytest.mark.asyncio
async def test_query_knowledge_graph_deduplication(
    mock_deep_research_deps, sample_graphiti_result, sample_mongo_chunk
):
