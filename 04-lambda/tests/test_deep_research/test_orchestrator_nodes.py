...
@pytest.mark.asyncio
async def test_planner_node_generates_outline(mock_deep_research_deps, sample_research_state, sample_search_results):
...
@pytest.mark.asyncio
async def test_planner_node_creates_vectors(mock_deep_research_deps, sample_research_state, sample_search_results):
...
@pytest.mark.asyncio
async def test_planner_node_pre_search(mock_deep_research_deps, sample_research_state, sample_search_results):
...
@pytest.mark.asyncio
async def test_executor_node_processes_vector(mock_deep_research_deps, sample_research_state, sample_research_vectors):
    ...
    with patch("server.projects.deep_research.orchestrator.search_web") as mock_search, \
        ...
        from server.projects.deep_research.models import (
            SearchWebResponse, SearchResult,
            FetchPageResponse,
            ParseDocumentResponse, DocumentChunk,
...
@pytest.mark.asyncio
async def test_executor_node_full_pipeline(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_executor_node_vector_status_updates(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_executor_node_error_handling(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_executor_node_iterates_vectors(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_auditor_node_validates_high_confidence(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_auditor_node_validates_low_confidence(mock_deep_research_deps, sample_research_state, sample_research_vectors):
    ...
    with patch("server.projects.deep_research.orchestrator.query_knowledge") as mock_query, \
        ...
        mock_result = Mock()
        mock_result.data = '{"confidence": "low", "evidence_found": false, "refined_query": "more detailed query"}'
        mock_agent.run = AsyncMock(return_value=mock_result)
...
@pytest.mark.asyncio
async def test_auditor_node_refinement_loop(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_auditor_node_missing_evidence(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_auditor_node_marks_verified(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_writer_node_generates_sections(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_writer_node_citations(mock_deep_research_deps, sample_research_state, sample_research_vectors):
    ...
    with patch("server.projects.deep_research.orchestrator.query_knowledge") as mock_query, \
        ...
        try:
            ...
            assert "[1]" in result_state["final_report"] or "citation" in result_state["final_report"].lower()
        finally:
            orchestrator_module._current_deps = None


@pytest.mark.asyncio
async def test_writer_node_closed_book_mode(mock_deep_research_deps, sample_research_state, sample_research_vectors):
...
@pytest.mark.asyncio
async def test_writer_node_combines_sections(mock_deep_research_deps, sample_research_state, sample_research_vectors):
    ...
    with patch("server.projects.deep_research.orchestrator.query_knowledge") as mock_query, \
        ...
        try:
            ...
            assert "Section 1" in result_state["final_report"] or "section" in result_state["final_report"].lower()
        finally:
            orchestrator_module._current_deps = None


@pytest.mark.asyncio
async def test_writer_node_sources_section(mock_deep_research_deps, sample_research_state, sample_research_vectors):
    ...
    with patch("server.projects.deep_research.orchestrator.query_knowledge") as mock_query, \
        ...
        try:
            ...
            assert "Sources" in result_state["final_report"] or "source" in result_state["final_report"].lower()
        finally:
            orchestrator_module._current_deps = None
