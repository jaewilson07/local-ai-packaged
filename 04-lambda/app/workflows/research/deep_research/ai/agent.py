...
from app.workflows.research.deep_research.models import (
    DocumentChunk,
    FetchPageRequest,
...
from app.workflows.research.deep_research.tools import (
    fetch_page,
    ingest_knowledge,
    parse_document,
    query_knowledge,
...
async def fetch_page_tool(ctx: RunContext[DeepResearchDeps], url: str) -> str:
    ...
    try:
        ...
        logger.exception("Error in fetch_page_tool")
...
async def parse_document_tool(
    ...
    try:
        ...
        logger.exception("Error in parse_document_tool")
...
async def ingest_knowledge_tool(
    ...
    try:
        ...
        logger.exception("Error in ingest_knowledge_tool")
...
async def query_knowledge_tool(
    ...
    try:
        ...
        logger.exception("Error in query_knowledge_tool")
