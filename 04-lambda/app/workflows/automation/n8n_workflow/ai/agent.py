...
from app.workflows.automation.n8n_workflow.dependencies import N8nWorkflowDeps
from app.workflows.automation.n8n_workflow.prompts import N8N_WORKFLOW_SYSTEM_PROMPT
...
n8n_workflow_agent = Agent(
    _get_n8n_workflow_model(), deps_type=N8nWorkflowDeps, system_prompt=N8N_WORKFLOW_SYSTEM_PROMPT
)
...
@n8n_workflow_agent.tool
async def delete_workflow_tool(ctx: RunContext[N8nWorkflowDeps], workflow_id: str) -> str:
    """
...
@n8n_workflow_agent.tool
async def list_workflows_tool(ctx: RunContext[N8nWorkflowDeps], active_only: bool = False) -> str:
    """
...
async def discover_n8n_nodes_tool(
    ctx: RunContext[N8nWorkflowDeps], category: str | None = None
) -> str:
    """
