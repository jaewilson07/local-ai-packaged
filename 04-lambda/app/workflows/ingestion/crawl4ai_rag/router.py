...
from app.workflows.ingestion.crawl4ai_rag.schemas import (
    CrawlDeepRequest,
    CrawlResponse,
    CrawlSinglePageRequest,
)
from app.workflows.ingestion.crawl4ai_rag.tools import (
...
get_crawl4ai_deps = create_dependency_factory(
    Crawl4AIDependencies, skip_mongodb=True, skip_openai=True
)
...
async def crawl_single(
    ...
    **Performance Notes:**
    ...
    try:
        ...
        logger.exception("Error in crawl_single")
...
async def crawl_deep_endpoint(
    ...
    **Best Practices:**
    ...
    try:
        ...
        logger.exception("Error in crawl_deep")
        raise HTTPException(status_code=500, detail=str(e)) from e
