...
async def search_graphiti(
    ...
    try:
        ...
        logger.exception("Error in search_graphiti tool")
        return f"Error: {e!s}"
...
async def parse_repository(
    ...
    try:
        ...
        logger = logging.getLogger(__name__)
        logger.exception("Error in parse_repository tool")
        return f"Error: {e!s}"
...
async def validate_script(
    ...
    try:
        ...
        logger = logging.getLogger(__name__)
        logger.exception("Error in validate_script tool")
        return f"Error: {e!s}"
...
async def query_graph(
    ...
    try:
        ...
        logger = logging.getLogger(__name__)
        logger.exception("Error in query_graph tool")
        return f"Error: {e!s}"
