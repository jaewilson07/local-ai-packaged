...
persona_agent = Agent(get_llm_model(), deps_type=PersonaDeps, system_prompt=PERSONA_SYSTEM_PROMPT)
...
async def update_persona_mood_tool(
    ...
    mood = MoodState(primary_emotion=primary_emotion, intensity=intensity, timestamp=datetime.now())
