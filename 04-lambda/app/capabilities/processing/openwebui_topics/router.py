...
from app.capabilities.processing.openwebui_topics.dependencies import OpenWebUITopicsDeps
from app.capabilities.processing.openwebui_topics.models import (
    TopicClassificationRequest,
    TopicClassificationResponse,
)
from app.capabilities.processing.openwebui_topics.tools import classify_topics
...
get_openwebui_topics_deps = create_dependency_factory(OpenWebUITopicsDeps)
