...
class RAGSummary(BaseModel):
    ...
    total_data_points: int = Field(default=0, description="Total data points across all RAG sources")
...
class ImmichSummary(BaseModel):
    ...
    message: Optional[str] = Field(None, description="Status message (e.g., if service unavailable)")
