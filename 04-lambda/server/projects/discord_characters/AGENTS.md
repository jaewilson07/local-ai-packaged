...
graph TB
    subgraph "Discord Bot"
        BOT[ Discord Bot<br/>03-apps/discord-character-bot ]
        CMD[ Command Handlers<br/>/add_character, etc. ]
...
The Discord bot service (`03-apps/discord-character-bot/`) handles:
- Discord connection and event handling
- Slash command registration
- Message mention detection
- Background engagement monitoring
- HTTP API calls to Lambda services
