...
from server.projects.openwebui_topics.models import TopicClassificationRequest, TopicClassificationResponse
...
class TopicClassifier:
    ...
    def _create_classification_prompt(self, conversation_text: str, title: Optional[str] = None) -> str:
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                payload = {
                    "model": self.model,
                    "messages": [
                        {"role": "system", "content": "You are a topic classification assistant. Always respond with valid JSON."},
            ...
            logger.exception(f"Failed to classify topics for conversation {request.conversation_id}: {e}")
