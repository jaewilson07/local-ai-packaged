...
from server.projects.mongo_rag.memory_models import MemoryMessage, MemoryFact, WebContent
...
class MongoMemoryStore(BaseMongoStore):
    ...
    def get_recent_messages(
        ...
        try:
            ...
            cursor = self.messages_collection.find(query).sort("created_at", DESCENDING).limit(limit)
