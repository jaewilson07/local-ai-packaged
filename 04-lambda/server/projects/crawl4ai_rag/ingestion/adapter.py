...
from server.projects.mongo_rag.ingestion.chunker import ChunkingConfig, create_chunker, DocumentChunk
...
class CrawledContentIngester:
    ...
    def __init__(
        ...
        self.graphiti_adapter: Optional[GraphitiIngestionAdapter] = None
        self.graphiti_deps: Optional[GraphitiRAGDeps] = None
    ...
    def _extract_metadata(self, url: str, markdown: str, crawl_metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    async def ingest_crawled_batch(
        ...
        logger.info(f"Starting parallel ingestion of {len(valid_pages)} pages (max_concurrent={max_concurrent})")
        ...
        results = await asyncio.gather(
            *[ingest_with_semaphore(page) for page in valid_pages],
