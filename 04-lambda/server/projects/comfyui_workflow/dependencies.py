...
class ComfyUIWorkflowDeps:
    ...
    # Configuration
    comfyui_url: str = field(default_factory=lambda: os.getenv("COMFYUI_URL", "http://comfyui:8188"))
    comfyui_web_user: str = field(default_factory=lambda: os.getenv("COMFYUI_WEB_USER", "user"))
    comfyui_web_password: str = field(default_factory=lambda: os.getenv("COMFYUI_WEB_PASSWORD", "password"))
