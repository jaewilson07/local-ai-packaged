...
from server.projects.mongo_rag.models import (
...
async def ingest(files: List[UploadFile] = File(...), clean_before: bool = False):
    """
...
async def search_code_examples_endpoint(request: CodeExampleSearchRequest):
    """
