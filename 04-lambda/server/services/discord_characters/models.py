...
class ChannelCharacter(BaseModel):
    ...
    added_at: datetime = Field(default_factory=datetime.utcnow, description="When character was added")
    message_count: int = Field(default=0, description="Number of messages from this character")
    last_active: Optional[datetime] = Field(default=None, description="Last time character was active")
...
class CharacterMessage(BaseModel):
    ...
    message_id: Optional[str] = Field(default=None, description="Discord message ID")
