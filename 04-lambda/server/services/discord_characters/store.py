...
class DiscordCharacterStore:
    ...
    def __init__(self, mongodb_url: str, db_name: str = "localai", db: Optional[Any] = None):
        """
    ...
    async def remove_character_from_channel(
    ...
    async def get_recent_messages(
        ...
        cursor = self.character_messages.find({
            "channel_id": channel_id,
            "character_id": character_id
