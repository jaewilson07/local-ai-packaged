    ...
    try:
        ...
        for char in characters:
            ...
            if character_name in message_lower or character_id in message_lower:
                ...
                if (message_lower.startswith(character_name) or
                    message_lower.startswith(character_id) or
                    f"@{character_name}" in message_lower or
                    f"@{character_id}" in message_lower):
        ...
        try:
            ...
            if result.get("success"):
                ...
                embed.set_author(
                    name=character_name,
                    icon_url=mentioned_character.get("profile_image")
                )
