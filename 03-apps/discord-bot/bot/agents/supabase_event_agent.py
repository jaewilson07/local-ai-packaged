...
class SupabaseEventAgent(BaseAgent):
    ...
    def __init__(
        ...
        self._discord_comm: Optional[DiscordCommunicationLayer] = None
    ...
    async def _create_event(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not server_id or not name or not start_time:
            raise ValueError("Create event task must have 'server_id', 'name', and 'start_time' fields")
