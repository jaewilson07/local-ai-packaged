...
class ServerInfo(BaseModel):
    ...
    icon_url: str | None = Field(None, description="Server icon URL")
...
class ChannelInfo(BaseModel):
    ...
    category_id: str | None = Field(None, description="Parent category ID")
...
class MemberInfo(BaseModel):
    ...
    display_name: str | None = Field(None, description="Display name (nickname)")
    roles: list[str] = Field(default_factory=list, description="List of role IDs")
    joined_at: str | None = Field(None, description="When user joined the server")
