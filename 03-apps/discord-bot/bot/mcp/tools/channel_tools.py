...
@mcp.tool
async def create_text_channel(server_id: str, name: str, category_id: Optional[str] = None) -> dict:
    """
...
@mcp.tool
async def move_channel(channel_id: str, category_id: Optional[str] = None, position: Optional[int] = None) -> dict:
    """
