...
import pytest
from bot.handlers.command_handler import PersonSelectView, setup_claim_face_command
...
@pytest.mark.asyncio
@pytest.mark.unit
async def test_claim_face_no_results(mock_discord_interaction, mock_immich_client, test_database):
...
@pytest.mark.asyncio
@pytest.mark.unit
async def test_claim_face_api_error(mock_discord_interaction, mock_immich_client, test_database):
