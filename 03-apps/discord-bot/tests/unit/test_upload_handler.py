...
from bot.handlers.upload_handler import handle_upload, DISCORD_FILE_SIZE_LIMIT
...
@pytest.mark.asyncio
@pytest.mark.unit
async def test_handle_upload_invalid_file_type(
    mock_discord_message, mock_immich_client
):
...
@pytest.mark.asyncio
@pytest.mark.unit
async def test_handle_upload_multiple_attachments(
    mock_discord_message, mock_immich_client
):
...
@pytest.mark.asyncio
@pytest.mark.unit
async def test_handle_upload_mixed_attachments(
    mock_discord_message, mock_immich_client
):
