...
async def test_full_upload_flow(test_database, mock_discord_message, mock_discord_attachment):
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_upload_flow_multiple_files(test_database, mock_discord_message):
