...
- **Issues Found**: {len(results.get('failures', []))} failures, {summary['errors']} errors
- **Notes**: 
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Track test debugging and update documentation"
    )
    parser.add_argument(
        "--results",
        type=str,
    ...
    parser.add_argument(
        "--generate-agents-summary",
        action="store_true",
        help="Generate summary for AGENTS.md"
    )
    parser.add_argument(
        "--add-issues",
        action="store_true",
        help="Add issues from test failures"
    )
