...
def run_tests(
    ...
    if uv_cmd:
        cmd = [
            ...
            "--tb=short",
            "--json-report",
            "--json-report-file", str(RESULTS_DIR / "pytest_report.json"),
        ]
    else:
        cmd = [
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run Deep Research Agent tests with reporting"
    )
    parser.add_argument(
        "--file",
        type=str,
        help="Run specific test file (e.g., test_tools.py)"
    )
    parser.add_argument(
        "--case",
        type=str,
        help="Run specific test case (e.g., test_search_web_success)"
    )
    parser.add_argument(
        "--coverage",
        action="store_true",
