...
- `setup/` - Installation, configuration, and utility scripts
  - `install_missing_dependencies.sh` - Install manually added dependencies
  - `comfyui_diagnostics.sh` - Comprehensive diagnostics script
  - Additional setup and maintenance scripts
- `docs/` - Project documentation and guides
  - Setup guides, troubleshooting, model references, and workflow documentation
- `config/` - Configuration files and provisioning scripts
