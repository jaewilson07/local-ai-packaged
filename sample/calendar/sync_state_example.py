...
async def main():
    ...
    try:
        ...
        if existing_state:
            ...
            print(f"   This means the event hasn't been synced yet.")
        print()
        ...
        if updated_state:
            ...
            print(f"❌ Sync state not found (unexpected)")
        print()
