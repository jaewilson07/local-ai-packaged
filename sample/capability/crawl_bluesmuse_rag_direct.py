...
async def validate_mongodb_ingestion_direct(
    search_query: str, deps: Crawl4AIDependencies
) -> dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            results = await search_knowledge_base(
                deps=agent_deps, query=search_query, search_type="hybrid", match_count=10
            )
