...
from capabilities.processing.openwebui_topics.agent import classify_topics_tool  # noqa: E402
from capabilities.processing.openwebui_topics.dependencies import OpenWebUITopicsDeps  # noqa: E402
...
async def main():
    ...
    try:
        ...
        if success:
            ...
            print("\n❌ Verification failed: No topics classified")
            sys.exit(1)
    finally:
        # Cleanup
        await deps.cleanup()
