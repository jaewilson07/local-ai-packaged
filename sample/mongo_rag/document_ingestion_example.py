...
if "MONGODB_URI" not in os.environ:
    ...
    os.environ["MONGODB_URI"] = "mongodb://admin:admin123@localhost:27017/?directConnection=true&authSource=admin"
...
async def main():
    ...
    if not docs_path.exists():
        ...
        print(f"   Create it and add some documents (PDF, .md, .txt, etc.) to ingest.")
    ...
    try:
        ...
        if not document_files:
            ...
            print(f"   Supported formats: PDF, Word, PowerPoint, Excel, HTML, Markdown, Text")
            sys.exit(1)
